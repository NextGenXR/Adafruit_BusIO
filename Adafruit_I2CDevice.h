...
public:
	...
	bool write(BufferTypeDef buffer, LengthTypeDef len = 1, bool stop = true, \
			 BufferTypeDef prefix_buffer = NULL, LengthTypeDef prefix_len = 0);
	bool write_then_read(BufferTypeDef write_buffer, LengthTypeDef write_len, \
			BufferTypeDef read_buffer, LengthTypeDef read_len, bool stop = false);
